...
public interface PlaySDKLib extends Library {
	...
	PlaySDKLib PLAYSDK_INSTANCE = (PlaySDKLib) Native.loadLibrary(INetSDK.getLoadLibrary("dhplay"), PlaySDKLib.class);	
	 ...
	 * @author 29779
	 */
	public static class T_VIDEO extends Structure{
	...
	public static class RenderType extends Structure
	{
	...
	public static class DecodeType extends Structure
	{
	 ...
	 * 抓图回调函数
	 */
	public interface IDisplayCBFun extends StdCallCallback {
		/**
		 * IDisplsyCBFun,
		 * @param nPort 通道号
		 * @param pBuf 返回图像数据
	...
	/************************************************************************/
	/* 函数: PLAY_SetEngine    DecodeType   RenderType
